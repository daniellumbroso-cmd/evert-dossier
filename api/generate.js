...
- RÈGLE DE COMPLÉTUDE — NOMBRE D'EXPÉRIENCES : le tableau "experiences" doit contenir TOUTES les expériences professionnelles du CV source, de la plus récente à la plus ancienne, sans exception et sans en écarter aucune sous prétexte qu'elle serait ancienne, courte ou moins pertinente. Si le CV contient 6 expériences, le dossier en contient 6 (une expérience fusionnée selon la règle de fusion compte pour une).
