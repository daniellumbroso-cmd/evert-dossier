...
function setupFonts(assetsDir) {
  ...
  try {
    ...
    fs.copyFileSync(
      path.join(assetsDir, 'Montserrat-Regular.ttf'),
      path.join(fontDir, 'Montserrat-Regular.ttf')
    )
    fs.copyFileSync(
      path.join(assetsDir, 'Montserrat-Bold.ttf'),
      path.join(fontDir, 'Montserrat-Bold.ttf')
    )
